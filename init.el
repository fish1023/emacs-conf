...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ivy-xref swiper diminish counsel ivy-rich ivy ibuffer-projectile projectile gnu-elpa-keyring-update fullframe seq spacemacs-theme color-theme-sanityinc-solarized solarized-theme gitconfig-mode gitignore-mode git-blamed auto-package-update vdiff-magit spaceline-all-the-icons helm-ag dockerfile-mode php-mode zerodark-theme))))
(custom-set-faces
